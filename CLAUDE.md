...
## Roadmap 23 step ที่ทำจริงรอบนี้ (S/M/L = ขนาดงาน; L = งานใหญ่ ยิงตอนโควตาเหลือเยอะ)
...
---
## สถานะโครงการ
**ล่าสุด: 3.9 เสร็จ (พิมพ์ฟอร์ม PDF ตามต้นฉบับ) — ถัดไป 3.5 AI Intake (งานใหญ่)**
...
_เสร็จแล้ว: 0.1 · 0.2 · 1.1–1.6 · 2.1–2.6 · 3.1 · 3.2 · 3.3 · 3.9 — ยังเหลือ 4 step: 3.5 · 3.6 · 3.7 · 3.8 (+1.7 ทดสอบเครื่องจริง)_
⚠️ ต้องรัน `db/phase3-9.sql` ใน Supabase — ไม่งั้นตารางสินค้า/ชื่อเล่นยังบันทึกไม่ได้
